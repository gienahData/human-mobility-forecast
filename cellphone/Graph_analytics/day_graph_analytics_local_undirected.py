...
## python3 day_graph_analytics_local_undirected.py --start_idx 0 --end_idx 1 --source_folder /media/Data_storage/Mobilcell/DayGraphData/ --target_folder /media/Data_storage/Mobilcell/DayGraphAnalytics_unweighted/ --unweighted 1 --source_pol /media/Data_storage/Mobilcell/DayPolygonData/
